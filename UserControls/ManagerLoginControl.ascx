<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ManagerLoginControl.ascx.cs" Inherits="UserControls_ManagerLoginControl" %>
    ...
    <div style="border-style: none; border-width: 1px; margin-top:34px; width:448px; height:320px">
            <table align="center" 
                ...
                <asp:Image ID="Image2" runat="server" Height="74px" 
                    ImageUrl="~/icons/Manager-icon.png" Width="86px" />
            </td>
                    <td align="left" 
